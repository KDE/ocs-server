...
//			if($this->readdata('type','int')<>0)		 $data['type']=$this->readdata('type','int');
			...
			if($this->readdata('downloadpackagename1','text')<>'') $data['downloadpackagename1'] =$this->readdata('downloadpackagename1','text');
			if($this->readdata('downloadrepository1','text')<>'')	$data['downloadrepository1'] =$this->readdata('downloadrepository1','text');
			...
			if($this->readdata('downloadpackagename2','text')<>'') $data['downloadpackagename2'] =$this->readdata('downloadpackagename2','text');
			if($this->readdata('downloadrepository2','text')<>'')	$data['downloadrepository2'] =$this->readdata('downloadrepository2','text');
			...
			if($this->readdata('downloadpackagename3','text')<>'') $data['downloadpackagename3'] =$this->readdata('downloadpackagename3','text');
			if($this->readdata('downloadrepository3','text')<>'')	$data['downloadrepository3'] =$this->readdata('downloadrepository3','text');
			...
			if($this->readdata('downloadpackagename4','text')<>'') $data['downloadpackagename4'] =$this->readdata('downloadpackagename4','text');
			if($this->readdata('downloadrepository4','text')<>'')	$data['downloadrepository4'] =$this->readdata('downloadrepository4','text');
			...
			if($this->readdata('downloadpackagename5','text')<>'') $data['downloadpackagename5'] =$this->readdata('downloadpackagename5','text');
			if($this->readdata('downloadrepository5','text')<>'')	$data['downloadrepository5'] =$this->readdata('downloadrepository5','text');
			...
			if($this->readdata('downloadpackagename6','text')<>'') $data['downloadpackagename6'] =$this->readdata('downloadpackagename6','text');
			if($this->readdata('downloadrepository6','text')<>'')	$data['downloadrepository6'] =$this->readdata('downloadrepository6','text');
			...
			if($this->readdata('downloadpackagename7','text')<>'') $data['downloadpackagename7'] =$this->readdata('downloadpackagename7','text');
			if($this->readdata('downloadrepository7','text')<>'')	$data['downloadrepository7'] =$this->readdata('downloadrepository7','text');
			...
			if($this->readdata('downloadpackagename8','text')<>'') $data['downloadpackagename8'] =$this->readdata('downloadpackagename8','text');
			if($this->readdata('downloadrepository8','text')<>'')	$data['downloadrepository8'] =$this->readdata('downloadrepository8','text');
			...
			if($this->readdata('downloadpackagename9','text')<>'') $data['downloadpackagename9'] =$this->readdata('downloadpackagename9','text');
			if($this->readdata('downloadrepository9','text')<>'')	$data['downloadrepository9'] =$this->readdata('downloadrepository9','text');
			...
			if($this->readdata('downloadpackagename10','text')<>'') $data['downloadpackagename10'] =$this->readdata('downloadpackagename10','text');
			if($this->readdata('downloadrepository10','text')<>'')	$data['downloadrepository10'] =$this->readdata('downloadrepository10','text');
			...
			if($this->readdata('downloadpackagename11','text')<>'') $data['downloadpackagename11'] =$this->readdata('downloadpackagename11','text');
			if($this->readdata('downloadrepository11','text')<>'')	$data['downloadrepository11'] =$this->readdata('downloadrepository11','text');
			...
			if($this->readdata('downloadpackagename12','text')<>'') $data['downloadpackagename12'] =$this->readdata('downloadpackagename12','text');
			if($this->readdata('downloadrepository12','text')<>'')	$data['downloadrepository12'] =$this->readdata('downloadrepository12','text');
